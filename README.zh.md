...
- [DMBOK 第 1–17 章来源映射](skills/managing-data-projects/references/source-map.md)；[跨域路由表](skills/managing-data-projects/references/routing-table.md)；[完成审计与行为评测](evals/skill-suite/completion-audit.md)。
